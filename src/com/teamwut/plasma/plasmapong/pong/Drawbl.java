...
public class Drawbl {
	...
	public static PlasmaFluid getFluidSim(PApplet p) {
...
//		return fluid;
	...
	public static PImage getGoalTop(PApplet p) {
	...
	public static PImage getGoalBottom(PApplet p) {
	...
	public static PImage getGoalMiddle(PApplet p) {
	...
	public static PImage fillSoftReference(PApplet p, SoftReference<PImage> softref, String name, boolean scaleVert, boolean scaleHoriz) {
